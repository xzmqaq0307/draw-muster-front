...
- [API](#api)
    ...
    - [阅前说明](#阅前说明)
    - [用户注册](#用户注册)
        - [检验姓名是否存在（v1版本修改）](#检验姓名是否存在v1版本修改)
        - [检验邮箱是否存在（v1版本修改）](#检验邮箱是否存在v1版本修改)
        - [获取账户验证码（v1版本修改）](#获取账户验证码v1版本修改)
        - [验证用户验证码（v1版本修改）](#验证用户验证码v1版本修改)
    - [用户登录](#用户登录)
    - [修改用户信息（v1版本修改）](#修改用户信息v1版本修改)
    - [修改用户密码（v1版本修改）](#修改用户密码v1版本修改)
    - [创建收藏夹](#创建收藏夹)
    - [获取收藏夹列表](#获取收藏夹列表)
    - [收藏夹内容（v1版本修改）](#收藏夹内容v1版本修改)
    - [添加作品到收藏夹（v1版本修改）](#添加作品到收藏夹v1版本修改)
    - [删除整个收藏夹（v1版本修改）](#删除整个收藏夹v1版本修改)
    - [删除收藏夹某一个内容（v1版本修改）](#删除收藏夹某一个内容v1版本修改)
    - [创建画册](#创建画册)
    ...
    - [创建画画（v1版本修改）](#创建画画v1版本修改)
    - [上传小文件接口（仅限于画画、头像、封面）](#上传小文件接口仅限于画画头像封面)
    - [查看某一幅画详情](#查看某一幅画详情)
    - [搜索作品](#搜索作品)
    - [搜索用户](#搜索用户)
    - [创建评论（v2版本新增）](#创建评论v2版本新增)
    - [回复某条评论（v2版本新增）](#回复某条评论v2版本新增)
    - [查询某个页面下的所有评论（v2版本新增）](#查询某个页面下的所有评论v2版本新增)
    - [查看某个评论下的回复（v2版本新增）](#查看某个评论下的回复v2版本新增)
    - [删除某条回复（v2版本新增）](#删除某条回复v2版本新增)
    - [删除某条评论（以及下面所有回复）（v2版本新增）](#删除某条评论以及下面所有回复v2版本新增)
    - [点赞（v2版本新增）](#点赞v2版本新增)
    - [获取公告列表（v2版本新增）](#获取公告列表v2版本新增)
